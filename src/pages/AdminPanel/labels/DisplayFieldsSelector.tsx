...
export const COMPONENT_FIELDS: Record<string, FieldDef[]> = {
  ...
  side: [
    ...
    { value: "side.name", label: "Boczek", source: "sides.name" },
  ...
  leg_chest: [
    { value: "legHeights.sofa_chest.leg", label: "Noga", source: "chests + series_config" },
    { value: "legHeights.sofa_chest.height", label: "H", source: "chests.leg_height_cm" },
    { value: "legHeights.sofa_chest.count", label: "Ilość", source: "chests.leg_count" },
  ],
  leg_seat: [
    { value: "legHeights.sofa_seat.leg", label: "Noga", source: "series_automats" },
    { value: "legHeights.sofa_seat.height", label: "H", source: "series_automats.seat_leg_height_cm" },
    { value: "legHeights.sofa_seat.count", label: "Ilość", source: "series_automats.seat_leg_count" },
  ],
  leg: [
    { value: "pufaLegs.code", label: "Noga", source: "series_config.pufa_leg_type" },
    { value: "pufaLegs.height", label: "H", source: "series_config.pufa_leg_height_cm" },
    { value: "pufaLegs.count", label: "Ilość", source: "series_config.pufa_leg_count" },
    { value: "fotelLegs.code", label: "Noga", source: "series_config.seat_leg_type" },
    { value: "fotelLegs.height", label: "H", source: "series_config.seat_leg_height_cm" },
