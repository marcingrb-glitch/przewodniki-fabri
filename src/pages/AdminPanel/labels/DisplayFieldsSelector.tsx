...
const COMPONENT_FIELDS: Record<string, FieldDef[]> = {
  seat: [
    ...
    { value: "seat.foamsList", label: "Pianki siedziska", source: "product_foams" },
    ...
    { value: "seat.springType", label: "Sprężyna siedziska", source: "seats_sofa.spring_type" },
  ...
  backrest: [
    ...
    { value: "backrest.foam", label: "Pianka oparcia (tekst)", source: "backrests.foam (legacy)" },
    { value: "backrest.foamsList", label: "Pianki oparcia (lista)", source: "product_foams" },
